...
module.exports = function(path) {
    ...
    return {
        ...
        //adaugati metoda changeItem in service.js care cauta dupa id in verctorul items elementul si daca il gaseste, 
        //atunci ii modifica textul si salveaza cu storeItems(items, path) continutul in fisier;
        changeItem(id, text) {
            const index = items.findIndex(i => i.id === id);
            if (index === -1) {
                return false;
